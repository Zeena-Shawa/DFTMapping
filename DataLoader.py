...
extra_column_headers = ['rating', 'user_ratings_total', 'website', 'transit_time_london']
...
class CsvDao(object):
    ...
    def __init__(self, file="data\Preferences_double_address.csv"):
        self.file = file
    ...
    def write_addresses_to_file(self, address_list, london_distance_list):
        with open(self.file, 'r') as read_file, open('data\Preferences_full.csv', 'w') as write_file:
